...
export class GolbatEye extends Node {
  constructor(GL, attribs) {
    ...
    var eyeSceneObj = new SceneObject(GL, eyeShape.vertices, eyeShape.faces, attribs, "POS_COL_NORM");
    ...
    var irisSceneObj = new SceneObject(GL, irisShape.vertices, irisShape.faces, attribs, "POS_COL_NORM");
