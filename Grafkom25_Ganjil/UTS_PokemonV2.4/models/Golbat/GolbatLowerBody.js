...
export class GolbatLowerBody extends Node {
  constructor(GL, attribs) {
    ...
    var thighSceneObject = new SceneObject(GL, legCylinder.vertices, legCylinder.faces, attribs, "POS_COL_NORM");
    var footSceneObject = new SceneObject(GL, footTube.vertices, footTube.faces, attribs, "POS_COL_NORM");
    var capSceneObject = new SceneObject(GL, capSphere.vertices, capSphere.faces, attribs, "POS_COL_NORM"); // <-- SceneObject untuk tutup
