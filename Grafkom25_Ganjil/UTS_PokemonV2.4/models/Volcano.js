...
export const Volcano = {
  /**
   * Helper baru untuk membuat geometri gunung berapi dengan kawah (frustum + kerucut terbalik).
   * Ini menggantikan _createVolcanoCone yang lama.
   */
  _createVolcanoWithCrater: function (
    ...
    let yOffset = 0; // Kita asumsikan pusat Y ada di 0
  ...
  /**
   * Membuat data geometri gabungan untuk gunung berapi.
   */
  createGeometry: function (baseRadius, height, segments) {
    ...
    // Panggil helper baru
    var geom = this._createVolcanoWithCrater(
      baseRadius,
      height,
      segments,
      topRadius,
  ...
  /**
   * Membuat SceneObject untuk gunung berapi.
  ...
  createSceneObject: function (GL, attribs, baseRadius, height, segments) {
    ...
    // Gunakan layout "POS_COL_UV" seperti Trees.js
    // Ini akan menggunakan vertex color dan mengabaikan tekstur
